/***************************************************************************
 * This file is a verbatim copy from IEEE 1364-2005 Annex G (normative).
 * May need indent.
 * The IEEE does not provide explicit use terms, nevertheless it should
 * be in the spirit of the Open Standard to use the raw copy in order to
 * enforce binary compability. If this is not the case, a rewrite from
 * scratch is a matter of hours. In any case the "normative" statement
 * does not allow significant creative deviation from the source text.
 */

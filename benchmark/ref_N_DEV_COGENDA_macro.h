//-------------------------------------------------------------------------
#ifndef Xyce_N_DEV_macro_h
#define Xyce_N_DEV_macro_h
...
{
  static const char *name() {return "COGENDA macro";}
  static const char *deviceTypeName() {return "macro level 1";}
...
public:
  ...
  private:
    ...
    //Branch Constants
    //Probe Constants
    static const int cogendaProbeID_V_a_c = 0;

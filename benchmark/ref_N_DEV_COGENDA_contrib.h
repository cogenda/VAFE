//-------------------------------------------------------------------------
#ifndef Xyce_N_DEV_contrib_h
#define Xyce_N_DEV_contrib_h
...
typedef Sacado::Fad::SFad<double,12> CogendaFadType;
...
{
  static const char *name() {return "COGENDA contrib";}
  static const char *deviceTypeName() {return "contrib level 1";}
...
public:
  ...
  private:
    ...
    double * f_dvdgdt_Equ_BRA_dvdgdt_GND_Var_Ptr;
    double * f_BRA_dvdgdt_GND_Equ_drain_Node_Ptr;
    double * f_BRA_dvdgdt_GND_Equ_gate_Node_Ptr;
    double * f_BRA_dvdgdt_GND_Equ_dvdgdt_Node_Ptr;
    ...
    double * f_nsat_Equ_BRA_nsat_GND_Var_Ptr;
    double * f_BRA_nsat_GND_Equ_nsat_Node_Ptr;
    ...
    double * q_dvdgdt_Equ_BRA_dvdgdt_GND_Var_Ptr;
    double * q_BRA_dvdgdt_GND_Equ_drain_Node_Ptr;
    double * q_BRA_dvdgdt_GND_Equ_gate_Node_Ptr;
    double * q_BRA_dvdgdt_GND_Equ_dvdgdt_Node_Ptr;
    ...
    double * q_nsat_Equ_BRA_nsat_GND_Var_Ptr;
    double * q_BRA_nsat_GND_Equ_nsat_Node_Ptr;
    ...
    int m_dvdgdt_Equ_BRA_dvdgdt_GND_VarOffset;
    int m_BRA_dvdgdt_GND_Equ_drain_NodeOffset;
    int m_BRA_dvdgdt_GND_Equ_gate_NodeOffset;
    int m_BRA_dvdgdt_GND_Equ_dvdgdt_NodeOffset;
    ...
    int m_nsat_Equ_BRA_nsat_GND_VarOffset;
    int m_BRA_nsat_GND_Equ_nsat_NodeOffset;
    ...
    //Branch Constants
    static const int cogendaBRA_ID_dvdgdt_GND = 10;
    static const int cogendaBRA_ID_dvbcdt_GND = 11;
    static const int cogendaBRA_ID_qceb_GND = 12;
    static const int cogendaBRA_ID_nsat_GND = 13;
    static const int cogendaBRA_ID_mucinv_GND = 14;
    //Probe Constants
    static const int cogendaProbeID_I_dvdgdt_GND = 0;
    static const int cogendaProbeID_I_dvbcdt_GND = 1;
    static const int cogendaProbeID_I_qceb_GND = 2;
    static const int cogendaProbeID_I_nsat_GND = 3;
    static const int cogendaProbeID_I_mucinv_GND = 4;
    static const int cogendaProbeID_V_drain_gate = 5;
    static const int cogendaProbeID_V_gate_cathode = 6;
    static const int cogendaProbeID_V_drain_cathode = 7;
    static const int cogendaProbeID_V_anode_emitter = 8;
    static const int cogendaProbeID_V_emitter_drain = 9;
    static const int cogendaProbeID_V_dvdgdt_GND = 10;
    static const int cogendaProbeID_V_qceb_GND = 11;

//-------------------------------------------------------------------------
#ifndef Xyce_N_DEV_switchcase_h
#define Xyce_N_DEV_switchcase_h
...
{
  static const char *name() {return "COGENDA switchcase";}
  static const char *deviceTypeName() {return "switchcase level 1";}

//-------------------------------------------------------------------------
#ifndef Xyce_N_DEV_nodecollaprev_h
#define Xyce_N_DEV_nodecollaprev_h
...
{
  static const char *name() {return "COGENDA nodecollaprev";}
  static const char *deviceTypeName() {return "nodecollaprev level 1";}
...
public:
  ...
  private:
    ...
    int li_branch_ia;
    //Jacobian pointers
    double * f_a1_Equ_a1_Node_Ptr;
    double * f_a1_Equ_c_Node_Ptr;
    double * f_c_Equ_a1_Node_Ptr;
    double * f_c_Equ_c_Node_Ptr;
    double * f_a_Equ_a_Node_Ptr;
    double * f_a_Equ_a1_Node_Ptr;
    double * f_a1_Equ_a_Node_Ptr;
    double * q_a1_Equ_a1_Node_Ptr;
    double * q_a1_Equ_c_Node_Ptr;
    double * q_c_Equ_a1_Node_Ptr;
    double * q_c_Equ_c_Node_Ptr;
    double * q_a_Equ_a_Node_Ptr;
    double * q_a_Equ_a1_Node_Ptr;
    double * q_a1_Equ_a_Node_Ptr;
    //Jacobian Offsets
    int m_a1_Equ_a1_NodeOffset;
    int m_a1_Equ_c_NodeOffset;
    int m_c_Equ_a1_NodeOffset;
    int m_c_Equ_c_NodeOffset;
    int m_a_Equ_a_NodeOffset;
    int m_a_Equ_a1_NodeOffset;
    int m_a1_Equ_a_NodeOffset;
    //Node Constants
    static const int cogendaNodeID_a = 0;
    static const int cogendaNodeID_c = 1;
    static const int cogendaNodeID_a1 = 2;
    static const int cogendaNodeID_GND = -1;
    //Branch Constants
    //Probe Constants
    static const int cogendaProbeID_V_a1_c = 0;
    static const int cogendaProbeID_V_a_a1 = 1;
    //Limited Probe Store LIDs
    //Collapsible Bools
    bool collapseNode_a1;
    //FadArrays
...
#endif //Xyce_N_DEV_nodecollaprev_h

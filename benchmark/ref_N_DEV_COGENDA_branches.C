...
PairMap Instance::pairToJacStampMap;
    ...
    const int Instance::cogendaBRA_ID_gate_cathode;
    const int Instance::cogendaBRA_ID_dvdgdt_emitter;
    const int Instance::cogendaBRA_ID_dvbcdt_GND;
    const int Instance::cogendaBRA_ID_qceb_GND;
    const int Instance::cogendaBRA_ID_drain_cathode;
    const int Instance::cogendaBRA_ID_nsat_mucinv;
    const int Instance::cogendaBRA_ID_mucinv_GND;

/* class Traits member functions */
  //void Traits::loadInstanceParameters() 
void Traits::loadInstanceParameters(ParametricData<COGENDAbranches::Instance> &p)
{
  ...
  // no "TEMP".
  p.addPar("XYCEADMSINSTTEMP", 0.0, &COGENDAbranches::Instance::cogendaInstTemp)
    .setExpressionAccess(NO_DOC)
    .setUnit(U_DEGK)
    .setCategory(CAT_TEMP)
    .setDescription("Internally set parameter for device instance temperature");
  p.addPar("CGD",static_cast<double>(1e-13), &COGENDAbranches::Instance::cgd);
  p.addPar("CGS",static_cast<double>(1e-13), &COGENDAbranches::Instance::cgs);
}

  //void Traits::loadModelParameters()
void Traits::loadModelParameters(ParametricData<COGENDAbranches::Model> &p)
{
  p.addPar("XYCEADMSMODTEMP", 0.0, &COGENDAbranches::Model::cogendaModTemp)
    .setExpressionAccess(NO_DOC)
    .setUnit(U_DEGK)
    .setCategory(CAT_TEMP)
    .setDescription("Internally set parameter for device model temperature");
  p.addPar("CGD",static_cast<double>(1e-13), &COGENDAbranches::Model::cgd);
  p.addPar("CGS",static_cast<double>(1e-13), &COGENDAbranches::Model::cgs);
}
...
Instance::Instance(
  ...
  : DeviceInstance(instance_block, configuration.getInstanceParameters(), factory_block),
    ...
    li_dvdgdt(-1),
    li_dvbcdt(-1),
    li_BRA_gate_cathode(-1),
    li_BRA_dvdgdt_emitter(-1),
    li_BRA_dvbcdt_GND(-1),
    li_BRA_qceb_GND(-1),
    li_BRA_drain_cathode(-1),
    li_BRA_nsat_mucinv(-1),
    li_BRA_mucinv_GND(-1),
    li_branch_ianode(-1),
    li_branch_igate(-1),
    ...
    f_gate_Equ_BRA_gate_cathode_Var_Ptr(0),
    f_BRA_gate_cathode_Equ_gate_Node_Ptr(0),
    f_cathode_Equ_BRA_gate_cathode_Var_Ptr(0),
    f_BRA_gate_cathode_Equ_cathode_Node_Ptr(0),
    f_BRA_gate_cathode_Equ_BRA_gate_cathode_Var_Ptr(0),
    ...
    f_dvdgdt_Equ_BRA_dvdgdt_emitter_Var_Ptr(0),
    f_emitter_Equ_BRA_dvdgdt_emitter_Var_Ptr(0),
    f_BRA_dvdgdt_emitter_Equ_drain_Node_Ptr(0),
    f_BRA_dvdgdt_emitter_Equ_gate_Node_Ptr(0),
    f_BRA_dvdgdt_emitter_Equ_dvdgdt_Node_Ptr(0),
    f_BRA_dvdgdt_emitter_Equ_emitter_Node_Ptr(0),
    f_dvbcdt_Equ_BRA_dvbcdt_GND_Var_Ptr(0),
    f_BRA_dvbcdt_GND_Equ_drain_Node_Ptr(0),
    f_BRA_dvbcdt_GND_Equ_cathode_Node_Ptr(0),
    f_BRA_dvbcdt_GND_Equ_emitter_Node_Ptr(0),
    ...
    f_nsat_Equ_BRA_nsat_mucinv_Var_Ptr(0),
    f_mucinv_Equ_BRA_nsat_mucinv_Var_Ptr(0),
    f_BRA_nsat_mucinv_Equ_nsat_Node_Ptr(0),
    f_BRA_nsat_mucinv_Equ_mucinv_Node_Ptr(0),
    f_drain_Equ_BRA_drain_cathode_Var_Ptr(0),
    f_cathode_Equ_BRA_drain_cathode_Var_Ptr(0),
    f_BRA_nsat_mucinv_Equ_BRA_drain_cathode_Var_Ptr(0),
    f_BRA_drain_cathode_Equ_BRA_drain_cathode_Var_Ptr(0),
    ...
    q_gate_Equ_BRA_gate_cathode_Var_Ptr(0),
    q_BRA_gate_cathode_Equ_gate_Node_Ptr(0),
    q_cathode_Equ_BRA_gate_cathode_Var_Ptr(0),
    q_BRA_gate_cathode_Equ_cathode_Node_Ptr(0),
    q_BRA_gate_cathode_Equ_BRA_gate_cathode_Var_Ptr(0),
    ...
    q_dvdgdt_Equ_BRA_dvdgdt_emitter_Var_Ptr(0),
    q_emitter_Equ_BRA_dvdgdt_emitter_Var_Ptr(0),
    q_BRA_dvdgdt_emitter_Equ_drain_Node_Ptr(0),
    q_BRA_dvdgdt_emitter_Equ_gate_Node_Ptr(0),
    q_BRA_dvdgdt_emitter_Equ_dvdgdt_Node_Ptr(0),
    q_BRA_dvdgdt_emitter_Equ_emitter_Node_Ptr(0),
    q_dvbcdt_Equ_BRA_dvbcdt_GND_Var_Ptr(0),
    q_BRA_dvbcdt_GND_Equ_drain_Node_Ptr(0),
    q_BRA_dvbcdt_GND_Equ_cathode_Node_Ptr(0),
    q_BRA_dvbcdt_GND_Equ_emitter_Node_Ptr(0),
    ...
    q_nsat_Equ_BRA_nsat_mucinv_Var_Ptr(0),
    q_mucinv_Equ_BRA_nsat_mucinv_Var_Ptr(0),
    q_BRA_nsat_mucinv_Equ_nsat_Node_Ptr(0),
    q_BRA_nsat_mucinv_Equ_mucinv_Node_Ptr(0),
    q_drain_Equ_BRA_drain_cathode_Var_Ptr(0),
    q_cathode_Equ_BRA_drain_cathode_Var_Ptr(0),
    q_BRA_nsat_mucinv_Equ_BRA_drain_cathode_Var_Ptr(0),
    q_BRA_drain_cathode_Equ_BRA_drain_cathode_Var_Ptr(0),
    ...
    m_gate_Equ_BRA_gate_cathode_VarOffset(-1),
    m_BRA_gate_cathode_Equ_gate_NodeOffset(-1),
    m_cathode_Equ_BRA_gate_cathode_VarOffset(-1),
    m_BRA_gate_cathode_Equ_cathode_NodeOffset(-1),
    m_BRA_gate_cathode_Equ_BRA_gate_cathode_VarOffset(-1),
    ...
    m_dvdgdt_Equ_BRA_dvdgdt_emitter_VarOffset(-1),
    m_emitter_Equ_BRA_dvdgdt_emitter_VarOffset(-1),
    m_BRA_dvdgdt_emitter_Equ_drain_NodeOffset(-1),
    m_BRA_dvdgdt_emitter_Equ_gate_NodeOffset(-1),
    m_BRA_dvdgdt_emitter_Equ_dvdgdt_NodeOffset(-1),
    m_BRA_dvdgdt_emitter_Equ_emitter_NodeOffset(-1),
    m_dvbcdt_Equ_BRA_dvbcdt_GND_VarOffset(-1),
    m_BRA_dvbcdt_GND_Equ_drain_NodeOffset(-1),
    m_BRA_dvbcdt_GND_Equ_cathode_NodeOffset(-1),
    m_BRA_dvbcdt_GND_Equ_emitter_NodeOffset(-1),
    ...
    m_nsat_Equ_BRA_nsat_mucinv_VarOffset(-1),
    m_mucinv_Equ_BRA_nsat_mucinv_VarOffset(-1),
    m_BRA_nsat_mucinv_Equ_nsat_NodeOffset(-1),
    m_BRA_nsat_mucinv_Equ_mucinv_NodeOffset(-1),
    m_drain_Equ_BRA_drain_cathode_VarOffset(-1),
    m_cathode_Equ_BRA_drain_cathode_VarOffset(-1),
    m_BRA_nsat_mucinv_Equ_BRA_drain_cathode_VarOffset(-1),
    m_BRA_drain_cathode_Equ_BRA_drain_cathode_VarOffset(-1),
      ...
      cogendaTemperature(getDeviceOptions().temp.getImmutableValue<double>())
{
  ...
  jacobianElements.push_back(IntPair(cogendaNodeID_gate,cogendaBRA_ID_gate_cathode));
  jacobianElements.push_back(IntPair(cogendaNodeID_cathode,cogendaBRA_ID_gate_cathode));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_gate_cathode,cogendaBRA_ID_gate_cathode));
  ...
  jacobianElements.push_back(IntPair(cogendaNodeID_dvdgdt,cogendaBRA_ID_dvdgdt_emitter));
  jacobianElements.push_back(IntPair(cogendaNodeID_emitter,cogendaBRA_ID_dvdgdt_emitter));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_dvdgdt_emitter,cogendaNodeID_drain));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_dvdgdt_emitter,cogendaNodeID_gate));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_dvdgdt_emitter,cogendaNodeID_dvdgdt));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_dvdgdt_emitter,cogendaNodeID_emitter));
  ...
  jacobianElements.push_back(IntPair(cogendaBRA_ID_dvbcdt_GND,cogendaNodeID_emitter));
  ...
  jacobianElements.push_back(IntPair(cogendaNodeID_nsat,cogendaBRA_ID_nsat_mucinv));
  jacobianElements.push_back(IntPair(cogendaNodeID_mucinv,cogendaBRA_ID_nsat_mucinv));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_nsat_mucinv,cogendaNodeID_nsat));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_nsat_mucinv,cogendaNodeID_mucinv));
  jacobianElements.push_back(IntPair(cogendaNodeID_drain,cogendaBRA_ID_drain_cathode));
  jacobianElements.push_back(IntPair(cogendaNodeID_cathode,cogendaBRA_ID_drain_cathode));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_nsat_mucinv,cogendaBRA_ID_drain_cathode));
  jacobianElements.push_back(IntPair(cogendaBRA_ID_drain_cathode,cogendaBRA_ID_drain_cathode));
                               ...
                               const LocalIdVector & extLIDVecRef)
{
  ...
  li_BRA_gate_cathode = localLIDVec[nodeMap[cogendaBRA_ID_gate_cathode]];
  li_BRA_dvdgdt_emitter = localLIDVec[nodeMap[cogendaBRA_ID_dvdgdt_emitter]];
  li_BRA_dvbcdt_GND = localLIDVec[nodeMap[cogendaBRA_ID_dvbcdt_GND]];
  li_BRA_qceb_GND = localLIDVec[nodeMap[cogendaBRA_ID_qceb_GND]];
  li_BRA_drain_cathode = localLIDVec[nodeMap[cogendaBRA_ID_drain_cathode]];
  li_BRA_nsat_mucinv = localLIDVec[nodeMap[cogendaBRA_ID_nsat_mucinv]];
...
void Instance::loadNodeSymbols(Util::SymbolTable &symbol_table) const
{
  ...
  addInternalNode(symbol_table, li_BRA_gate_cathode, getName(), "gate_cathode_branch");
  addInternalNode(symbol_table, li_BRA_dvdgdt_emitter, getName(), "dvdgdt_emitter_branch");
  ...
  addInternalNode(symbol_table, li_BRA_drain_cathode, getName(), "drain_cathode_branch");
  addInternalNode(symbol_table, li_BRA_nsat_mucinv, getName(), "nsat_mucinv_branch");
...
void Instance::registerJacLIDs( const JacobianStamp & jacLIDVec)
{
  ...
  jacLoc = pairToJacStampMap[IntPair(cogendaNodeID_gate,cogendaBRA_ID_gate_cathode)];
  m_gate_Equ_BRA_gate_cathode_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_gate_cathode,cogendaNodeID_gate)];
  m_BRA_gate_cathode_Equ_gate_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaNodeID_cathode,cogendaBRA_ID_gate_cathode)];
  m_cathode_Equ_BRA_gate_cathode_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_gate_cathode,cogendaNodeID_cathode)];
  m_BRA_gate_cathode_Equ_cathode_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_gate_cathode,cogendaBRA_ID_gate_cathode)];
  m_BRA_gate_cathode_Equ_BRA_gate_cathode_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  ...
  jacLoc = pairToJacStampMap[IntPair(cogendaNodeID_dvdgdt,cogendaBRA_ID_dvdgdt_emitter)];
  m_dvdgdt_Equ_BRA_dvdgdt_emitter_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaNodeID_emitter,cogendaBRA_ID_dvdgdt_emitter)];
  m_emitter_Equ_BRA_dvdgdt_emitter_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_dvdgdt_emitter,cogendaNodeID_drain)];
  m_BRA_dvdgdt_emitter_Equ_drain_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_dvdgdt_emitter,cogendaNodeID_gate)];
  m_BRA_dvdgdt_emitter_Equ_gate_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_dvdgdt_emitter,cogendaNodeID_dvdgdt)];
  m_BRA_dvdgdt_emitter_Equ_dvdgdt_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_dvdgdt_emitter,cogendaNodeID_emitter)];
  m_BRA_dvdgdt_emitter_Equ_emitter_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  ...
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_dvbcdt_GND,cogendaNodeID_emitter)];
  m_BRA_dvbcdt_GND_Equ_emitter_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  ...
  jacLoc = pairToJacStampMap[IntPair(cogendaNodeID_nsat,cogendaBRA_ID_nsat_mucinv)];
  m_nsat_Equ_BRA_nsat_mucinv_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaNodeID_mucinv,cogendaBRA_ID_nsat_mucinv)];
  m_mucinv_Equ_BRA_nsat_mucinv_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_nsat_mucinv,cogendaNodeID_nsat)];
  m_BRA_nsat_mucinv_Equ_nsat_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_nsat_mucinv,cogendaNodeID_mucinv)];
  m_BRA_nsat_mucinv_Equ_mucinv_NodeOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaNodeID_drain,cogendaBRA_ID_drain_cathode)];
  m_drain_Equ_BRA_drain_cathode_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaNodeID_cathode,cogendaBRA_ID_drain_cathode)];
  m_cathode_Equ_BRA_drain_cathode_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_nsat_mucinv,cogendaBRA_ID_drain_cathode)];
  m_BRA_nsat_mucinv_Equ_BRA_drain_cathode_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
  jacLoc = pairToJacStampMap[IntPair(cogendaBRA_ID_drain_cathode,cogendaBRA_ID_drain_cathode)];
  m_BRA_drain_cathode_Equ_BRA_drain_cathode_VarOffset = jacLIDVec[jacLoc.first][jacLoc.second];
...
void Instance::setupPointers( )
{
  ...
  f_gate_Equ_BRA_gate_cathode_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_gate,li_BRA_gate_cathode);
  f_BRA_gate_cathode_Equ_gate_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_gate_cathode,li_gate);
  f_cathode_Equ_BRA_gate_cathode_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_cathode,li_BRA_gate_cathode);
  f_BRA_gate_cathode_Equ_cathode_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_gate_cathode,li_cathode);
  f_BRA_gate_cathode_Equ_BRA_gate_cathode_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_gate_cathode,li_BRA_gate_cathode);
  ...
  f_dvdgdt_Equ_BRA_dvdgdt_emitter_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_dvdgdt,li_BRA_dvdgdt_emitter);
  f_emitter_Equ_BRA_dvdgdt_emitter_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_emitter,li_BRA_dvdgdt_emitter);
  f_BRA_dvdgdt_emitter_Equ_drain_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_dvdgdt_emitter,li_drain);
  f_BRA_dvdgdt_emitter_Equ_gate_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_dvdgdt_emitter,li_gate);
  f_BRA_dvdgdt_emitter_Equ_dvdgdt_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_dvdgdt_emitter,li_dvdgdt);
  f_BRA_dvdgdt_emitter_Equ_emitter_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_dvdgdt_emitter,li_emitter);
  ...
  f_BRA_dvbcdt_GND_Equ_emitter_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_dvbcdt_GND,li_emitter);
  ...
  f_nsat_Equ_BRA_nsat_mucinv_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_nsat,li_BRA_nsat_mucinv);
  f_mucinv_Equ_BRA_nsat_mucinv_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_mucinv,li_BRA_nsat_mucinv);
  f_BRA_nsat_mucinv_Equ_nsat_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_nsat_mucinv,li_nsat);
  f_BRA_nsat_mucinv_Equ_mucinv_Node_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_nsat_mucinv,li_mucinv);
  f_drain_Equ_BRA_drain_cathode_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_drain,li_BRA_drain_cathode);
  f_cathode_Equ_BRA_drain_cathode_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_cathode,li_BRA_drain_cathode);
  f_BRA_nsat_mucinv_Equ_BRA_drain_cathode_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_nsat_mucinv,li_BRA_drain_cathode);
  f_BRA_drain_cathode_Equ_BRA_drain_cathode_Var_Ptr = dFdxMatPtr->returnRawEntryPointer(li_BRA_drain_cathode,li_BRA_drain_cathode);
  ...
  q_gate_Equ_BRA_gate_cathode_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_gate,li_BRA_gate_cathode);
  q_BRA_gate_cathode_Equ_gate_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_gate_cathode,li_gate);
  q_cathode_Equ_BRA_gate_cathode_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_cathode,li_BRA_gate_cathode);
  q_BRA_gate_cathode_Equ_cathode_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_gate_cathode,li_cathode);
  q_BRA_gate_cathode_Equ_BRA_gate_cathode_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_gate_cathode,li_BRA_gate_cathode);
  ...
  q_dvdgdt_Equ_BRA_dvdgdt_emitter_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_dvdgdt,li_BRA_dvdgdt_emitter);
  q_emitter_Equ_BRA_dvdgdt_emitter_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_emitter,li_BRA_dvdgdt_emitter);
  q_BRA_dvdgdt_emitter_Equ_drain_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_dvdgdt_emitter,li_drain);
  q_BRA_dvdgdt_emitter_Equ_gate_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_dvdgdt_emitter,li_gate);
  q_BRA_dvdgdt_emitter_Equ_dvdgdt_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_dvdgdt_emitter,li_dvdgdt);
  q_BRA_dvdgdt_emitter_Equ_emitter_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_dvdgdt_emitter,li_emitter);
  ...
  q_BRA_dvbcdt_GND_Equ_emitter_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_dvbcdt_GND,li_emitter);
  ...
  q_nsat_Equ_BRA_nsat_mucinv_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_nsat,li_BRA_nsat_mucinv);
  q_mucinv_Equ_BRA_nsat_mucinv_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_mucinv,li_BRA_nsat_mucinv);
  q_BRA_nsat_mucinv_Equ_nsat_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_nsat_mucinv,li_nsat);
  q_BRA_nsat_mucinv_Equ_mucinv_Node_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_nsat_mucinv,li_mucinv);
  q_drain_Equ_BRA_drain_cathode_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_drain,li_BRA_drain_cathode);
  q_cathode_Equ_BRA_drain_cathode_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_cathode,li_BRA_drain_cathode);
  q_BRA_nsat_mucinv_Equ_BRA_drain_cathode_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_nsat_mucinv,li_BRA_drain_cathode);
  q_BRA_drain_cathode_Equ_BRA_drain_cathode_Var_Ptr = dQdxMatPtr->returnRawEntryPointer(li_BRA_drain_cathode,li_BRA_drain_cathode);
...
bool Instance::loadDAEFVector()
{
  ...
  (*extData.daeFVectorPtr)[li_BRA_gate_cathode] += staticContributions[cogendaBRA_ID_gate_cathode].val();
  (*extData.daeFVectorPtr)[li_BRA_dvdgdt_emitter] += staticContributions[cogendaBRA_ID_dvdgdt_emitter].val();
  ...
  (*extData.daeFVectorPtr)[li_BRA_drain_cathode] += staticContributions[cogendaBRA_ID_drain_cathode].val();
  (*extData.daeFVectorPtr)[li_BRA_nsat_mucinv] += staticContributions[cogendaBRA_ID_nsat_mucinv].val();
...
bool Instance::loadDAEQVector()
{
  ...
  (*extData.daeQVectorPtr)[li_BRA_gate_cathode] += dynamicContributions[cogendaBRA_ID_gate_cathode].val();
  (*extData.daeQVectorPtr)[li_BRA_dvdgdt_emitter] += dynamicContributions[cogendaBRA_ID_dvdgdt_emitter].val();
  ...
  (*extData.daeQVectorPtr)[li_BRA_drain_cathode] += dynamicContributions[cogendaBRA_ID_drain_cathode].val();
  (*extData.daeQVectorPtr)[li_BRA_nsat_mucinv] += dynamicContributions[cogendaBRA_ID_nsat_mucinv].val();
...
bool Instance::updateIntermediateVars()
{
  ...
  {
    probeVars.resize(14);
    staticContributions.resize(10+7);
    dynamicContributions.resize(10+7);
  }
  ...
  probeVars[cogendaProbeID_I_gate_cathode] = (*solVectorPtr)[li_BRA_gate_cathode];
  probeVars[cogendaProbeID_I_gate_cathode].diff(cogendaProbeID_I_gate_cathode,14);
  probeVars[cogendaProbeID_I_dvdgdt_emitter] = (*solVectorPtr)[li_BRA_dvdgdt_emitter];
  probeVars[cogendaProbeID_I_dvdgdt_emitter].diff(cogendaProbeID_I_dvdgdt_emitter,14);
  probeVars[cogendaProbeID_I_dvbcdt_GND] = (*solVectorPtr)[li_BRA_dvbcdt_GND];
  probeVars[cogendaProbeID_I_dvbcdt_GND].diff(cogendaProbeID_I_dvbcdt_GND,14);
  probeVars[cogendaProbeID_I_qceb_GND] = (*solVectorPtr)[li_BRA_qceb_GND];
  probeVars[cogendaProbeID_I_qceb_GND].diff(cogendaProbeID_I_qceb_GND,14);
  probeVars[cogendaProbeID_I_drain_cathode] = (*solVectorPtr)[li_BRA_drain_cathode];
  probeVars[cogendaProbeID_I_drain_cathode].diff(cogendaProbeID_I_drain_cathode,14);
  probeVars[cogendaProbeID_I_nsat_mucinv] = (*solVectorPtr)[li_BRA_nsat_mucinv];
  probeVars[cogendaProbeID_I_nsat_mucinv].diff(cogendaProbeID_I_nsat_mucinv,14);
  probeVars[cogendaProbeID_I_mucinv_GND] = (*solVectorPtr)[li_BRA_mucinv_GND];
  probeVars[cogendaProbeID_I_mucinv_GND].diff(cogendaProbeID_I_mucinv_GND,14);
  probeVars[cogendaProbeID_V_drain_gate] = (*solVectorPtr)[li_drain] - (*solVectorPtr)[li_gate];
  probeVars[cogendaProbeID_V_drain_gate].diff(cogendaProbeID_V_drain_gate,14);
  probeVars[cogendaProbeID_V_gate_cathode] = (*solVectorPtr)[li_gate] - (*solVectorPtr)[li_cathode];
  probeVars[cogendaProbeID_V_gate_cathode].diff(cogendaProbeID_V_gate_cathode,14);
  probeVars[cogendaProbeID_V_drain_cathode] = (*solVectorPtr)[li_drain] - (*solVectorPtr)[li_cathode];
  probeVars[cogendaProbeID_V_drain_cathode].diff(cogendaProbeID_V_drain_cathode,14);
  probeVars[cogendaProbeID_V_anode_emitter] = (*solVectorPtr)[li_anode] - (*solVectorPtr)[li_emitter];
  probeVars[cogendaProbeID_V_anode_emitter].diff(cogendaProbeID_V_anode_emitter,14);
  probeVars[cogendaProbeID_V_emitter_drain] = (*solVectorPtr)[li_emitter] - (*solVectorPtr)[li_drain];
  probeVars[cogendaProbeID_V_emitter_drain].diff(cogendaProbeID_V_emitter_drain,14);
  probeVars[cogendaProbeID_V_dvdgdt_GND] = (*solVectorPtr)[li_dvdgdt];
  probeVars[cogendaProbeID_V_dvdgdt_GND].diff(cogendaProbeID_V_dvdgdt_GND,14);
  probeVars[cogendaProbeID_V_qceb_GND] = (*solVectorPtr)[li_qceb];
  probeVars[cogendaProbeID_V_qceb_GND].diff(cogendaProbeID_V_qceb_GND,14);

{
  ...
  qcgs = (this->cgs*vgs);
  icdg = (this->cgd*probeVars[cogendaProbeID_V_dvdgdt_GND]);
//I-contrib...
  staticContributions[cogendaNodeID_anode] += ((vae/rb)+probeVars[cogendaProbeID_I_gate_cathode]);
  staticContributions[cogendaNodeID_emitter] -= ((vae/rb)+probeVars[cogendaProbeID_I_gate_cathode]);
//Q-contrib...
...
//Q-contrib...
  dynamicContributions[cogendaNodeID_drain] += ((imos+imult)+(this->cgs*(qcdsj)));
  dynamicContributions[cogendaNodeID_cathode] -= ((imos+imult)+(this->cgs*(qcdsj)));
//I-contrib...
...
//V-contrib...
  dynamicContributions[cogendaBRA_ID_dvdgdt_emitter] += (vdg);
//V-contrib...
  dynamicContributions[cogendaBRA_ID_dvbcdt_GND] += (ved+(vds));
//V-contrib...
  staticContributions[cogendaBRA_ID_qceb_GND] += ((probeVars[cogendaProbeID_V_qceb_GND]-vebj)+ved);
//V-contrib...
  staticContributions[cogendaBRA_ID_nsat_mucinv] += (nsat1/probeVars[cogendaProbeID_I_drain_cathode]);
//V-contrib...
  staticContributions[cogendaBRA_ID_mucinv_GND] += mucinv1;
}
staticContributions[cogendaNodeID_dvdgdt] += probeVars[cogendaProbeID_I_dvdgdt_emitter];
staticContributions[cogendaNodeID_emitter] -= probeVars[cogendaProbeID_I_dvdgdt_emitter];
staticContributions[cogendaBRA_ID_dvdgdt_emitter] -= (*solVectorPtr)[li_dvdgdt]-(*solVectorPtr)[li_emitter];
...
staticContributions[cogendaNodeID_nsat] += probeVars[cogendaProbeID_I_nsat_mucinv];
staticContributions[cogendaNodeID_mucinv] -= probeVars[cogendaProbeID_I_nsat_mucinv];
staticContributions[cogendaBRA_ID_nsat_mucinv] -= (*solVectorPtr)[li_nsat]-(*solVectorPtr)[li_mucinv];
...
bool Instance::loadDAEdFdx()
{
  ...
  (*f_gate_Equ_BRA_gate_cathode_Var_Ptr) +=  +staticContributions[cogendaNodeID_gate].dx(cogendaProbeID_I_gate_cathode);
  (*f_BRA_gate_cathode_Equ_gate_Node_Ptr) +=  -1;
  (*f_cathode_Equ_BRA_gate_cathode_Var_Ptr) +=  +staticContributions[cogendaNodeID_cathode].dx(cogendaProbeID_I_gate_cathode);
  (*f_BRA_gate_cathode_Equ_cathode_Node_Ptr) +=  +1;
  (*f_BRA_gate_cathode_Equ_BRA_gate_cathode_Var_Ptr) +=  +staticContributions[cogendaBRA_ID_gate_cathode].dx(cogendaProbeID_I_gate_cathode);
  (*f_dvdgdt_Equ_BRA_dvdgdt_emitter_Var_Ptr) +=  +staticContributions[cogendaNodeID_dvdgdt].dx(cogendaProbeID_I_dvdgdt_emitter);
  (*f_emitter_Equ_BRA_dvdgdt_emitter_Var_Ptr) +=  +staticContributions[cogendaNodeID_emitter].dx(cogendaProbeID_I_dvdgdt_emitter);
  (*f_BRA_dvdgdt_emitter_Equ_dvdgdt_Node_Ptr) +=  -1;
  (*f_BRA_dvdgdt_emitter_Equ_emitter_Node_Ptr) +=  +1;
  ...
  (*f_nsat_Equ_BRA_nsat_mucinv_Var_Ptr) +=  +staticContributions[cogendaNodeID_nsat].dx(cogendaProbeID_I_nsat_mucinv);
  (*f_mucinv_Equ_BRA_nsat_mucinv_Var_Ptr) +=  +staticContributions[cogendaNodeID_mucinv].dx(cogendaProbeID_I_nsat_mucinv);
  (*f_BRA_nsat_mucinv_Equ_nsat_Node_Ptr) +=  -1;
  (*f_BRA_nsat_mucinv_Equ_mucinv_Node_Ptr) +=  +1;
  (*f_drain_Equ_BRA_drain_cathode_Var_Ptr) +=  +staticContributions[cogendaBRA_ID_drain].dx(cogendaProbeID_I_drain_cathode);
  (*f_cathode_Equ_BRA_drain_cathode_Var_Ptr) +=  +staticContributions[cogendaBRA_ID_cathode].dx(cogendaProbeID_I_drain_cathode);
  (*f_BRA_nsat_mucinv_Equ_BRA_drain_cathode_Var_Ptr) +=  +staticContributions[cogendaBRA_ID_nsat_mucinv].dx(cogendaProbeID_I_drain_cathode);
  (*f_BRA_drain_cathode_Equ_BRA_drain_cathode_Var_Ptr) +=  +staticContributions[cogendaBRA_ID_drain_cathode].dx(cogendaProbeID_I_drain_cathode);
  ...
  dFdx[li_gate][m_gate_Equ_BRA_gate_cathode_VarOffset] +=  +staticContributions[cogendaNodeID_gate].dx(cogendaProbeID_I_gate_cathode);
  dFdx[li_BRA_gate_cathode][m_BRA_gate_cathode_Equ_gate_NodeOffset] +=  -1;
  dFdx[li_cathode][m_cathode_Equ_BRA_gate_cathode_VarOffset] +=  +staticContributions[cogendaNodeID_cathode].dx(cogendaProbeID_I_gate_cathode);
  dFdx[li_BRA_gate_cathode][m_BRA_gate_cathode_Equ_cathode_NodeOffset] +=  +1;
  dFdx[li_BRA_gate_cathode][m_BRA_gate_cathode_Equ_BRA_gate_cathode_VarOffset] +=  +staticContributions[cogendaBRA_ID_gate_cathode].dx(cogendaProbeID_I_gate_cathode);
  dFdx[li_dvdgdt][m_dvdgdt_Equ_BRA_dvdgdt_emitter_VarOffset] +=  +staticContributions[cogendaNodeID_dvdgdt].dx(cogendaProbeID_I_dvdgdt_emitter);
  dFdx[li_emitter][m_emitter_Equ_BRA_dvdgdt_emitter_VarOffset] +=  +staticContributions[cogendaNodeID_emitter].dx(cogendaProbeID_I_dvdgdt_emitter);
  dFdx[li_BRA_dvdgdt_emitter][m_BRA_dvdgdt_emitter_Equ_dvdgdt_NodeOffset] +=  -1;
  dFdx[li_BRA_dvdgdt_emitter][m_BRA_dvdgdt_emitter_Equ_emitter_NodeOffset] +=  +1;
  ...
  dFdx[li_nsat][m_nsat_Equ_BRA_nsat_mucinv_VarOffset] +=  +staticContributions[cogendaNodeID_nsat].dx(cogendaProbeID_I_nsat_mucinv);
  dFdx[li_mucinv][m_mucinv_Equ_BRA_nsat_mucinv_VarOffset] +=  +staticContributions[cogendaNodeID_mucinv].dx(cogendaProbeID_I_nsat_mucinv);
  dFdx[li_BRA_nsat_mucinv][m_BRA_nsat_mucinv_Equ_nsat_NodeOffset] +=  -1;
  dFdx[li_BRA_nsat_mucinv][m_BRA_nsat_mucinv_Equ_mucinv_NodeOffset] +=  +1;
  dFdx[li_drain][m_drain_Equ_BRA_drain_cathode_VarOffset] +=  +staticContributions[cogendaBRA_ID_drain].dx(cogendaProbeID_I_drain_cathode);
  dFdx[li_cathode][m_cathode_Equ_BRA_drain_cathode_VarOffset] +=  +staticContributions[cogendaBRA_ID_cathode].dx(cogendaProbeID_I_drain_cathode);
  dFdx[li_BRA_nsat_mucinv][m_BRA_nsat_mucinv_Equ_BRA_drain_cathode_VarOffset] +=  +staticContributions[cogendaBRA_ID_nsat_mucinv].dx(cogendaProbeID_I_drain_cathode);
  dFdx[li_BRA_drain_cathode][m_BRA_drain_cathode_Equ_BRA_drain_cathode_VarOffset] +=  +staticContributions[cogendaBRA_ID_drain_cathode].dx(cogendaProbeID_I_drain_cathode);
...
bool Instance::loadDAEdQdx()
{
...
#ifndef Xyce_NONPOINTER_MATRIX_LOAD
  (*q_dvdgdt_Equ_BRA_dvdgdt_emitter_Var_Ptr) +=  +dynamicContributions[cogendaNodeID_dvdgdt].dx(cogendaProbeID_I_dvdgdt_emitter);
  (*q_emitter_Equ_BRA_dvdgdt_emitter_Var_Ptr) +=  +dynamicContributions[cogendaNodeID_emitter].dx(cogendaProbeID_I_dvdgdt_emitter);
  (*q_BRA_dvdgdt_emitter_Equ_drain_Node_Ptr) +=  +dynamicContributions[cogendaBRA_ID_dvdgdt_emitter].dx(cogendaProbeID_V_drain_gate);
  (*q_BRA_dvdgdt_emitter_Equ_gate_Node_Ptr) +=  -dynamicContributions[cogendaBRA_ID_dvdgdt_emitter].dx(cogendaProbeID_V_drain_gate);
  ...
  (*q_BRA_dvbcdt_GND_Equ_emitter_Node_Ptr) +=  +dynamicContributions[cogendaBRA_ID_dvbcdt_GND].dx(cogendaProbeID_V_emitter_drain);
  (*q_qceb_Equ_BRA_qceb_GND_Var_Ptr) +=  +dynamicContributions[cogendaNodeID_qceb].dx(cogendaProbeID_I_qceb_GND);
  (*q_nsat_Equ_BRA_nsat_mucinv_Var_Ptr) +=  +dynamicContributions[cogendaNodeID_nsat].dx(cogendaProbeID_I_nsat_mucinv);
  (*q_mucinv_Equ_BRA_nsat_mucinv_Var_Ptr) +=  +dynamicContributions[cogendaNodeID_mucinv].dx(cogendaProbeID_I_nsat_mucinv);
  (*q_drain_Equ_BRA_drain_cathode_Var_Ptr) +=  +dynamicContributions[cogendaBRA_ID_drain].dx(cogendaProbeID_I_drain_cathode);
  (*q_cathode_Equ_BRA_drain_cathode_Var_Ptr) +=  +dynamicContributions[cogendaBRA_ID_cathode].dx(cogendaProbeID_I_drain_cathode);
  (*q_BRA_nsat_mucinv_Equ_BRA_drain_cathode_Var_Ptr) +=  +dynamicContributions[cogendaBRA_ID_nsat_mucinv].dx(cogendaProbeID_I_drain_cathode);
  (*q_BRA_drain_cathode_Equ_BRA_drain_cathode_Var_Ptr) +=  +dynamicContributions[cogendaBRA_ID_drain_cathode].dx(cogendaProbeID_I_drain_cathode);
...
#else
  //use the offsets instead of pointers
  dQdx[li_dvdgdt][m_dvdgdt_Equ_BRA_dvdgdt_emitter_VarOffset] +=  +dynamicContributions[cogendaNodeID_dvdgdt].dx(cogendaProbeID_I_dvdgdt_emitter);
  dQdx[li_emitter][m_emitter_Equ_BRA_dvdgdt_emitter_VarOffset] +=  +dynamicContributions[cogendaNodeID_emitter].dx(cogendaProbeID_I_dvdgdt_emitter);
  dQdx[li_BRA_dvdgdt_emitter][m_BRA_dvdgdt_emitter_Equ_drain_NodeOffset] +=  +dynamicContributions[cogendaBRA_ID_dvdgdt_emitter].dx(cogendaProbeID_V_drain_gate);
  dQdx[li_BRA_dvdgdt_emitter][m_BRA_dvdgdt_emitter_Equ_gate_NodeOffset] +=  -dynamicContributions[cogendaBRA_ID_dvdgdt_emitter].dx(cogendaProbeID_V_drain_gate);
  ...
  dQdx[li_BRA_dvbcdt_GND][m_BRA_dvbcdt_GND_Equ_emitter_NodeOffset] +=  +dynamicContributions[cogendaBRA_ID_dvbcdt_GND].dx(cogendaProbeID_V_emitter_drain);
  dQdx[li_qceb][m_qceb_Equ_BRA_qceb_GND_VarOffset] +=  +dynamicContributions[cogendaNodeID_qceb].dx(cogendaProbeID_I_qceb_GND);
  dQdx[li_nsat][m_nsat_Equ_BRA_nsat_mucinv_VarOffset] +=  +dynamicContributions[cogendaNodeID_nsat].dx(cogendaProbeID_I_nsat_mucinv);
  dQdx[li_mucinv][m_mucinv_Equ_BRA_nsat_mucinv_VarOffset] +=  +dynamicContributions[cogendaNodeID_mucinv].dx(cogendaProbeID_I_nsat_mucinv);
  dQdx[li_drain][m_drain_Equ_BRA_drain_cathode_VarOffset] +=  +dynamicContributions[cogendaBRA_ID_drain].dx(cogendaProbeID_I_drain_cathode);
  dQdx[li_cathode][m_cathode_Equ_BRA_drain_cathode_VarOffset] +=  +dynamicContributions[cogendaBRA_ID_cathode].dx(cogendaProbeID_I_drain_cathode);
  dQdx[li_BRA_nsat_mucinv][m_BRA_nsat_mucinv_Equ_BRA_drain_cathode_VarOffset] +=  +dynamicContributions[cogendaBRA_ID_nsat_mucinv].dx(cogendaProbeID_I_drain_cathode);
  dQdx[li_BRA_drain_cathode][m_BRA_drain_cathode_Equ_BRA_drain_cathode_VarOffset] +=  +dynamicContributions[cogendaBRA_ID_drain_cathode].dx(cogendaProbeID_I_drain_cathode);
...
/* class Model member functions */
  ...
  if(!given("CGD"))
    ...
    UserError0(*this) << "Model Parameter value " << cgd << " out of range (0:inf)";
  if(!given("CGS"))
    cgs = 1e-13;
  else if ( !(cgs > 0))
    UserError0(*this) << "Model Parameter value " << cgs << " out of range (0:inf)";
}
...
void registerDevice()
{
  Config<Traits>::addConfiguration()
    .registerDevice("branches", 1)
    .registerModelType("branches", 1);
}
} // namespace COGENDAbranches
} // namespace Device
} // namespace Xyce
...
struct Bootstrap {
 Bootstrap() {
  Xyce::Device::COGENDAbranches::registerDevice(); }}; 
Bootstrap COGENDAbranches_bootstrap;

//-------------------------------------------------------------------------
#ifndef Xyce_N_DEV_operats_h
#define Xyce_N_DEV_operats_h
...
{
  static const char *name() {return "COGENDA operats";}
  static const char *deviceTypeName() {return "operats level 1";}

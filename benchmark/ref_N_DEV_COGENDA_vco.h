//-------------------------------------------------------------------------
#ifndef Xyce_N_DEV_vco_h
#define Xyce_N_DEV_vco_h
...
{
  static const char *name() {return "COGENDA vco";}
  static const char *deviceTypeName() {return "vco level 1";}
...
public:
  ...
  private:
    ...
    int li_branch_iout;
    //Jacobian pointers
    double * f_out_Equ_BRA_out_GND_Var_Ptr;
    double * f_BRA_out_GND_Equ_out_Node_Ptr;
    double * q_out_Equ_BRA_out_GND_Var_Ptr;
    double * q_BRA_out_GND_Equ_out_Node_Ptr;
    //Jacobian Offsets
    int m_out_Equ_BRA_out_GND_VarOffset;
    int m_BRA_out_GND_Equ_out_NodeOffset;
    //Node Constants
    static const int cogendaNodeID_out = 0;
    static const int cogendaNodeID_in = 1;
    static const int cogendaNodeID_GND = -1;
    //Branch Constants
    static const int cogendaBRA_ID_out_GND = 2;
    //Probe Constants
    static const int cogendaProbeID_I_out_GND = 0;
    static const int cogendaProbeID_V_in_GND = 1;

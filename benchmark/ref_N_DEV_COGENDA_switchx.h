//-------------------------------------------------------------------------
#ifndef Xyce_N_DEV_switchx_h
#define Xyce_N_DEV_switchx_h
...
{
  static const char *name() {return "COGENDA switchx";}
  static const char *deviceTypeName() {return "switchx level 1";}
...
public:
  ...
  private:
    ...
    int li_branch_ic;
    //Jacobian pointers
    double * f_p_Equ_BRA_p_n_Var_Ptr;
    double * f_n_Equ_BRA_p_n_Var_Ptr;
    double * f_BRA_p_n_Equ_p_Node_Ptr;
    double * f_BRA_p_n_Equ_n_Node_Ptr;
    double * f_BRA_p_n_Equ_BRA_p_n_Var_Ptr;
    double * q_p_Equ_BRA_p_n_Var_Ptr;
    double * q_n_Equ_BRA_p_n_Var_Ptr;
    double * q_BRA_p_n_Equ_p_Node_Ptr;
    double * q_BRA_p_n_Equ_n_Node_Ptr;
    double * q_BRA_p_n_Equ_BRA_p_n_Var_Ptr;
    //Jacobian Offsets
    int m_p_Equ_BRA_p_n_VarOffset;
    int m_n_Equ_BRA_p_n_VarOffset;
    int m_BRA_p_n_Equ_p_NodeOffset;
    int m_BRA_p_n_Equ_n_NodeOffset;
    int m_BRA_p_n_Equ_BRA_p_n_VarOffset;
    //Node Constants
    static const int cogendaNodeID_p = 0;
    static const int cogendaNodeID_n = 1;
    static const int cogendaNodeID_c = 2;
    static const int cogendaNodeID_GND = -1;
    //Branch Constants
    static const int cogendaBRA_ID_p_n = 3;
    //Probe Constants
    static const int cogendaProbeID_I_p_n = 0;
    static const int cogendaProbeID_V_c_GND = 1;
